...
fs.writeFile(
  ...
  `
  {
    "compilerOptions": {
      ...
      // "outFile": "./isi-panable.js",                                  /* Specify a file that bundles all outputs into one JavaScript file. If declaration is true, also designates a file that bundles all .d.ts output. */
      ...
      // "strictNullChecks": true,                         /* When type checking, take into accountnull and undefined. */
